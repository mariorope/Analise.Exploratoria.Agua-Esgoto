...
**Extra:**
<p align="justify">
Se você quiser visualizar e explorar os dados um pouco mais através de um dashboard interativo criado with Tableua, click <a href="https://public.tableau.com/app/profile/mario.rodrigues.peres/viz/Dashboard_Water_Sanitation/Dashboard_home" target="_blank">aqui</a>). Você será direcionado para o meu repositório do Tableau Public, onde você poderá interagir com os gráficos e tabelas e fazer consultas aggregadas por região ou estado. Além disso você ainda pode realizar análise de volumes de água tratada e consumida, bem como de volumes de esgoto coletado e tratado.</p>
